 ...
 * 2019-07-28T02:02:08.778-03:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "CalculadoraWSService",
                  wsdlLocation = "file:/C:/WorkSpace Eclipse Photon x64/tw-calculadora-ws/WebContent/wsdl/calculadoraws.wsdl",
...
public class CalculadoraWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/WorkSpace Eclipse Photon x64/tw-calculadora-ws/WebContent/wsdl/calculadoraws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CalculadoraWSService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/WorkSpace Eclipse Photon x64/tw-calculadora-ws/WebContent/wsdl/calculadoraws.wsdl");
        }
        WSDL_LOCATION = url;
    }
